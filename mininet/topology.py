...
def run():
    ...
    net.addLink(server,  switch, bw=10, delay='10ms', loss=0)
    net.addLink(client1, switch, bw=10, delay='10ms', loss=10)
    net.addLink(client2, switch, bw=10, delay='10ms', loss=10)
    net.addLink(client3, switch, bw=10, delay='10ms', loss=10)
